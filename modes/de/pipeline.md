...
Verarbeitet URLs von Stellenanzeigen, die in `data/pipeline.md` gesammelt wurden. Der Kandidat wirft URLs ins Inbox, wann immer er eine entdeckt, und führt später `/naymi-ai pipeline` aus, um sie alle in einem Rutsch zu verarbeiten.
