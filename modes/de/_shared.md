# Geteilter Kontext -- naymi-ai (Deutsch)

<!-- ============================================================
     ANPASSEN DIESER DATEI
     ============================================================
     Diese Datei enthält den geteilten Kontext für alle naymi-ai-Modi
     in der deutschen Variante. Bevor du naymi-ai verwendest, MUSST du:
