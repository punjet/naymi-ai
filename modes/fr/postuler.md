...
5. **naymi-ai proof point** : inclure dans "Informations complementaires" si un tel champ existe
...
3. Suggerer l'etape suivante : `/naymi-ai contacto` pour du LinkedIn outreach vers le hiring manager
