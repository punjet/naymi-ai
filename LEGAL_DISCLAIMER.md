...
`naymi-ai` is a collection of Markdown prompts, Node.js scripts, and HTML templates. It is strictly a local execution tool. The maintainers do not host, deploy, or operate an AI system, nor do we provide API access to Large Language Models (LLMs).
...
naymi-ai interacts with career portals and job boards (Greenhouse, Lever, Ashby, Workday, and others).
...
naymi-ai is designed to help individuals make better career decisions, not to automate away human judgment. Acceptable use includes:
