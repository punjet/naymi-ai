...
# naymi-ai batch runner — standalone orchestrator for claude -p workers
...
usage() {
  cat <<'USAGE'
naymi-ai batch runner — process job offers in batch via claude -p workers
